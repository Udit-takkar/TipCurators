...
function CreatePost() {
  ...
  const handleSubmit = async e => {
    try {
      ...
      console.log("cid generated by IPFS", added.path);
      const url = `https://ipfs.infura.io/ipfs/${added.path}`;

      console.log("anyone can access this url to get content", url);
  ...
  return (
    ...
    >
      ...
      />
      <button
        style={{ padding: "10px", backgroundColor: "#06285e", color: "white" }}
